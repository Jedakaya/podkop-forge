...
# Возможности из podkop-evolution

## Подписки (Subscription URL)

Поддержка subscription URL — ссылки подписки от провайдера прокси. При выборе типа конфигурации **Subscription** в LuCI:
...
> **Добавлено в Podkop Forge:** кнопка «Update subscription» на дашборде — ручное обновление подписки прямо из веб-интерфейса, без захода в терминал.
